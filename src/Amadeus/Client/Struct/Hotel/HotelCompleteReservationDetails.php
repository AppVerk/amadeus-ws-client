...
use Amadeus\Client\RequestOptions\Hotel\CompleteReservationDetails\RetrievalKeyGroup;
 ...
 */
class HotelCompleteReservationDetails extends BaseWsMessage
{
    /**
    ...
    /**
     * Hotel_CompleteReservationDetails constructor.
     *
    ...
    {
        $this->retrievalKeyGroup = $options->retrievalKeyGroup;
    }
}
